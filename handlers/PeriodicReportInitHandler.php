...
class PeriodicReportInitHandler {
	...
	public function smartyInit(Smarty $hook_data) {
		...
		$plugin_templates = PLUGINS_DIR . DIRECTORY_SEPARATOR . LMSPeriodicReportPlugin::plugin_directory_name . DIRECTORY_SEPARATOR . 'templates';
	...
	public function ModulesDirInit(array $hook_data = array()) {
		$plugin_modules = PLUGINS_DIR . DIRECTORY_SEPARATOR . LMSPeriodicReportPlugin::plugin_directory_name . DIRECTORY_SEPARATOR . 'modules';
	...
	public function accessTableInit() {
		...
		$access->insertPermission(new Permission('poridic_report', trans('gereration of periodic reports'), '^PeriodicReport$'),
